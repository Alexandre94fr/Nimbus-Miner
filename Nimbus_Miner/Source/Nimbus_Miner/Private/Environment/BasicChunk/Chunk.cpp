...
void AChunk::CreateFace(Directions direction, FVector position)
{
...
TArray<FVector> AChunk::GetFaceVertices(Directions direction, FVector position) const
{
...
FVector AChunk::GetPositionInDirection(Directions direction, FVector position) const
{
	switch (direction)
	{
...
int AChunk::GetBlockIndex(int xPosition, int yPosition, int zPosition) const
{
